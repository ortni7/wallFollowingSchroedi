...
(cl:defmethod cl:initialize-instance :after ((m <Spawn-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Spawn-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ohm_mecanum_sim-srv:<Spawn-request> is deprecated: use ohm_mecanum_sim-srv:Spawn-request instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Spawn-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ohm_mecanum_sim-srv:x-val is deprecated.  Use ohm_mecanum_sim-srv:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Spawn-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ohm_mecanum_sim-srv:y-val is deprecated.  Use ohm_mecanum_sim-srv:y instead.")
  (y m))

(cl:ensure-generic-function 'theta-val :lambda-list '(m))
(cl:defmethod theta-val ((m <Spawn-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ohm_mecanum_sim-srv:theta-val is deprecated.  Use ohm_mecanum_sim-srv:theta instead.")
  (theta m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Spawn-request>)))
  ...
  "c1497b6490cf67615397a2f4c091d32a")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Spawn-request)))
  "Returns md5sum for a message object of type 'Spawn-request"
  "c1497b6490cf67615397a2f4c091d32a")
...
(cl:defmethod cl:initialize-instance :after ((m <Spawn-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Spawn-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ohm_mecanum_sim-srv:<Spawn-response> is deprecated: use ohm_mecanum_sim-srv:Spawn-response instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Spawn-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ohm_mecanum_sim-srv:x-val is deprecated.  Use ohm_mecanum_sim-srv:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Spawn-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ohm_mecanum_sim-srv:y-val is deprecated.  Use ohm_mecanum_sim-srv:y instead.")
  (y m))

(cl:ensure-generic-function 'theta-val :lambda-list '(m))
(cl:defmethod theta-val ((m <Spawn-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ohm_mecanum_sim-srv:theta-val is deprecated.  Use ohm_mecanum_sim-srv:theta instead.")
  (theta m))
